...
INSERT INTO links VALUES(11,1,2,575,595,29,'normal','bracket','[[file:missing.org]]','file:missing.org',NULL,'file','missing.org',NULL,'/home/hubisan/projects/coding/org-files-db/.project/manual-tests/files/link-file-resolve/notes/missing.org',NULL,NULL,NULL,NULL,'broken','file target is missing from the indexed universe');
...
INSERT INTO links VALUES(13,1,2,631,659,31,'normal','bracket','[[./other/missing-peer.org]]','./other/missing-peer.org',NULL,'file','./other/missing-peer.org',NULL,'/home/hubisan/projects/coding/org-files-db/.project/manual-tests/files/link-file-resolve/notes/other/missing-peer.org',NULL,NULL,NULL,NULL,'broken','file target is missing from the indexed universe');
...
INSERT INTO links VALUES(15,1,2,794,814,39,'normal','bracket','[[id:target-id-001]]','id:target-id-001',NULL,'id','target-id-001',NULL,NULL,NULL,NULL,NULL,NULL,'unsupported','no resolver implemented for link_type');
INSERT INTO links VALUES(16,1,2,817,832,40,'normal','bracket','[[#main-index]]','#main-index',NULL,'custom-id','#main-index',NULL,NULL,NULL,NULL,NULL,NULL,'unsupported','no resolver implemented for link_type');
INSERT INTO links VALUES(17,1,2,835,858,41,'normal','bracket','[[https://example.org]]','https://example.org',NULL,'https','//example.org',NULL,NULL,NULL,NULL,NULL,NULL,'unsupported','no resolver implemented for link_type');
