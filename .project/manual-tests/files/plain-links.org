...
These should not be stored once ignored-region handling is wired into link scanning.
...
These should be parsed according to the Phase 3 parsed-region policy.
